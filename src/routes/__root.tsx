...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "HolboxAI" },
      { property: "og:title", content: "HolboxAI - Powering the Future with AI" },
      { property: "og:description", content: "Powering the Future with AI. Battle-tested generative AI infrastructure for the enterprise." },
